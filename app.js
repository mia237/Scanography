...
function myFunctionphoto() {
  ...
  function myFunction5() {
    document.getElementById("demo5").innerHTML = "<br><br><br><br>Throughout this page are various scanned flowers. This was done by placing the flowers and letting the scan run without moving the flowers.<br> Extra Scanography resources covering what it is and how to start your own scans: ";
  }
